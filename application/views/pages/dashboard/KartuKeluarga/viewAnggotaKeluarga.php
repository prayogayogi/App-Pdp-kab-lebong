				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Table Data Anggota Keluarga : <b><?= $keluarga['nama_kk'] ?></b></h3>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col">
									<div class="card">
													...
													<?php foreach ($getDataKk as $data) : ?>
														<tr>
															...
															<td>
																...
																<?php ($data['status'] == "MENINGGAL") ? print_r(' || MENINGGAL') : '' ?>
															</td>
															<td><?= $data['no_kk']; ?></td>
										...
										<div class="card-footer">
											<a href="<?= base_url('DataKkController') ?>" class="btn btn-dark pr-4"><i class="fas fa-arrow-alt-circle-left mr-2"></i>Back</a>
										</div>
									</div>
								</div>
							</div>
...
<!-- Modal Unutk Detail Anggota Keluarga -->
<?php foreach ($getDataKk as $data) : ?>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="staticBackdropLabel">Detail Data Anggota Keluarga</h5>
				...
				<div class="modal-body">
					<div class="card-body">
						...
						<dl class="row justify-content-center">
							...
							<dt class="col-sm-6">No Kartu Keluarga</dt>
