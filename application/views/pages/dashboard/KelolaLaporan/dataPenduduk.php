<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Laporan Data Penduduk </h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Laporan Data Penduduk <?= date("Y"); ?></h3>
						...
						<div class="card-body">
							<div class="row">
								<div class="col">
									<div class="card">
										<div class="card-header">
											<form action="<?= base_url('Laporan/CetakLaporanController') ?>" method="POST" target="blank">
																			...
																			<div class="buttons">
																				...
																				<button type="button" class="btn btn-primary">
																					Data Penduduk<span class="badge bg-transparent">
																						<h5 class="pl-1 my-2"><?= $penduduk; ?></h5>
																					</span>
																				</button>
																			</div>
																		</div>
